...
const TOOLBAR_BUTTONS: &[ToolbarButton] = &[
    ToolbarButton { icon: "B", title: "Bold", prefix: "**", suffix: "**", default_text: "bold text", block: false },
    ToolbarButton { icon: "I", title: "Italic", prefix: "*", suffix: "*", default_text: "italic text", block: false },
    ToolbarButton { icon: "S", title: "Strikethrough", prefix: "~~", suffix: "~~", default_text: "strikethrough", block: false },
    ToolbarButton { icon: "H1", title: "Heading 1", prefix: "# ", suffix: "", default_text: "Heading", block: true },
    ToolbarButton { icon: "H2", title: "Heading 2", prefix: "## ", suffix: "", default_text: "Heading", block: true },
    ToolbarButton { icon: "H3", title: "Heading 3", prefix: "### ", suffix: "", default_text: "Heading", block: true },
    ToolbarButton { icon: "↗", title: "Link", prefix: "[", suffix: "](url)", default_text: "link text", block: false },
    ToolbarButton { icon: "▧", title: "Image", prefix: "![", suffix: "](url)", default_text: "alt text", block: false },
    ToolbarButton { icon: "<>", title: "Inline Code", prefix: "`", suffix: "`", default_text: "code", block: false },
    ToolbarButton { icon: "{}", title: "Code Block", prefix: "```\n", suffix: "\n```", default_text: "code here", block: true },
    ToolbarButton { icon: "❝", title: "Blockquote", prefix: "> ", suffix: "", default_text: "quote", block: true },
    ToolbarButton { icon: "•", title: "Unordered List", prefix: "- ", suffix: "", default_text: "list item", block: true },
    ToolbarButton { icon: "1.", title: "Ordered List", prefix: "1. ", suffix: "", default_text: "list item", block: true },
    ToolbarButton { icon: "▦", title: "Table", prefix: "| Header 1 | Header 2 | Header 3 |\n|----------|----------|----------|\n| Cell 1   | Cell 2   | Cell 3   |", suffix: "", default_text: "", block: true },
    ToolbarButton { icon: "—", title: "Horizontal Rule", prefix: "\n---\n", suffix: "", default_text: "", block: true },
    ToolbarButton { icon: "◇", title: "Mermaid Diagram", prefix: "```mermaid\nflowchart LR\n    A[Start] --> B[End]", suffix: "\n```", default_text: "", block: true },
];

/// Insert Markdown syntax into the textarea at the cursor position.
fn insert_markdown(textarea_id: &str, source: RwSignal<String>, prefix: &str, suffix: &str, default_text: &str, _block: bool) {
    let Some(textarea) = crate::infrastructure::browser::get_element_by_id::<HtmlTextAreaElement>(textarea_id) else { return; };
    ...
    let insert_text = if selected.is_empty() { default_text } else { selected };
...
pub fn Toolbar(
    ...
    let buttons: Vec<_> = TOOLBAR_BUTTONS.iter().enumerate().map(|(idx, btn)| {
