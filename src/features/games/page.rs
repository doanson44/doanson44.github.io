...
use crate::domain::games::{
    ...
    puzzle_is_solved, puzzle_move, slide_2048, snake_step, sudoku_given, sudoku_puzzle_with_seed,
    sudoku_valid, tetris_clear_filled, tetris_rotate_cw, ttt_best_move_sized, ttt_is_draw_sized,
...
fn board_pong(score: RwSignal<u32>, status: RwSignal<String>) -> AnyView {
    ...
    let start_loop: Rc<dyn Fn()> = {
        ...
        Rc::new(move || {
            ...
            let tick_frame: PongAnimationFrame = Rc::new(RefCell::new(None));
                ...
                if running.get() {
                    ...
                    if let Some(callback) = callback_ref.as_ref() {
                        ...
                        if let Ok(id) = callback_window_clone
                            .request_animation_frame(callback_js.unchecked_ref())
                        {
