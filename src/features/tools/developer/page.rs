    ...
    view! {
        <div class="d-flex flex-column flex-grow-1 overflow-hidden">
            ...
            <div class="d-flex flex-column flex-lg-row flex-grow-1 overflow-hidden">
                <section class="developer-tool-pane d-flex flex-column flex-grow-1 overflow-hidden" aria-labelledby="developer-input-title">
                ...
                <section class="developer-tool-pane d-flex flex-column flex-grow-1 overflow-hidden border-top border-secondary" aria-labelledby="developer-result-title">
