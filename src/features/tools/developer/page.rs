    ...
    view! {
        <div class="d-flex flex-column flex-grow-1 overflow-hidden">
            ...
            <div class="d-flex flex-column flex-lg-row flex-grow-1 overflow-hidden">
                <section class="d-flex flex-column flex-grow-1 overflow-hidden" aria-labelledby="developer-input-title">
                    ...
                    {secondary_label.map(|label| view! { <div class="border-top border-secondary p-2 flex-shrink-0"><label class="form-label small text-body-secondary mb-1" for="developer-secondary-input">{label}</label><textarea id="developer-secondary-input" class="form-control form-control-sm font-monospace" rows="4" prop:value=move || state.secondary.get() on:input=move |ev| state.set_secondary(event_target_value(&ev))></textarea></div> })}
                </section>
                <section class="d-flex flex-column flex-grow-1 overflow-hidden border-top border-lg-start" aria-labelledby="developer-result-title">
