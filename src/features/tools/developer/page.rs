    ...
    view! {
        <div class="d-flex flex-column flex-grow-1 overflow-hidden">
            ...
            <div class="d-flex flex-column flex-lg-row flex-grow-1 overflow-hidden">
                <section class="d-flex flex-column flex-grow-1 flex-basis-0 border-end-lg border-secondary" aria-labelledby="developer-input-title">
                ...
                <section class="d-flex flex-column flex-grow-1 flex-basis-0" aria-labelledby="developer-result-title">
