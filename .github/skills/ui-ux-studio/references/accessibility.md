# Accessibility Guidelines — Markdown Studio
...
- Focus order follows visual order: Navbar → Toolbar → Editor → Preview → Footer
...
- Rendered Markdown uses proper heading hierarchy (h1→h6)
- Lists use `<ul>/<ol>/<li>`
