...
description: "Work with Bootstrap 5.3 styling and theming across the doanson44.github.io platform. Use when: customizing Bootstrap dark/light themes, adding new CSS, creating Bootstrap component variants, working with utility classes, setting up CSS variables for theming, or modifying styles/app.css."
---

# Bootstrap Theming — doanson44.github.io
...
| File | Purpose |
|------|---------|
| `styles/app.css` | Custom styles — edit freely |
...
```css
/* Default: mobile (< 576px) — stacked layout, 16px editor font, 
   always-visible copy buttons, scrollable tables */

/* sm ≥ 576px */
@media (min-width: 576px) { }

/* md ≥ 768px — navbar expands, split pane side-by-side */
...
- ❌ Hardcode colors in Rust `view!` (use CSS classes)
- ❌ Modify Bootstrap CDN files
- ❌ Use `style="..."` inline attributes
- ❌ Override Bootstrap variables globally without understanding side effects
