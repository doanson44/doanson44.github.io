...
description: "Create a new Leptos 0.7 component for doanson44.github.io platform following clean architecture. Use when: adding shared platform component (Navbar, Footer, Cards, etc.), creating feature-specific UI, building reactive views with signals/memos/effects, adding new panel, widget, or page."
---
