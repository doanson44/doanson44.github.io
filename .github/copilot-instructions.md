...
## UI / UX
- Tailwind utilities are the default styling mechanism. Use project-owned component classes only for repeated semantic patterns that would otherwise duplicate complex styling.
