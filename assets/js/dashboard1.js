...
$(function () {
  ...
  // ==============================================================
  if ($(".sales").length) {
    var salesChart = new Chartist.Line(
      ".sales",
      {
    ...
    salesChart.on("draw", function (ctx) {
      if (ctx.type === "area") {
        ctx.element.attr({
          x1: ctx.x1 + 0.001,
        });
    ...
    salesChart.on("created", function (ctx) {
