...
Use `ui-ux-studio` skill â†’ `references/dark-mode-rules.md`:
...
Use `ui-ux-studio` skill â†’ `references/accessibility.md`:
...
- [ ] Type text â€” preview updates in real-time
- [ ] Click each toolbar button â€” formatting inserts at cursor
...
- [ ] Very long line (1000+ chars) â€” doesn't break layout
- [ ] Very long document (1000+ lines) â€” editor remains responsive
- [ ] Empty editor â€” preview shows empty state or nothing
- [ ] Invalid Mermaid syntax â€” shows error, doesn't crash preview
- [ ] Special characters (emoji, CJK) â€” render correctly
- [ ] Rapid typing â€” no lag or flicker

### Phase 7: Code Quality (3 min)
- [ ] No hardcoded colors â€” use Bootstrap classes or CSS variables
...
```
## Design Review â€” [Date]

### Status: âœ… Pass / âš ï¸ Issues Found

### Issues Found:
1. [Issue description] â€” [Location] â€” [Severity: High/Med/Low]
2. ...

### Verified:
- Dark mode: âœ…
- Responsive (375/576/768/1024/1280/1920): âœ…
