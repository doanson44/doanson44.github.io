# Domain & Service Skill â€” doanson44.github.io
...
â”‚ FEATURES     â”‚ RwSignal, Memo, page comp.   â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ APPLICATION  â”‚ Services + Port traits        â”‚  â† this skill covers
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ DOMAIN       â”‚ Pure Rust, zero framework depsâ”‚  â† this skill covers
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ INFRASTRUCTUREâ”‚ Browser APIs, JS interop      â”‚  â† this skill covers
...
### Rules
- **Zero framework deps** â€” NO `leptos`, `web-sys`, `wasm-bindgen`
...
for event in parser {
    match event {
        Event::Start(Tag::CodeBlock(CodeBlockKind::Fenced(lang))) => {
            // Detect language: "mermaid" â†’ MermaidBlock, "rust" â†’ syntax highlight, etc.
        }
        Event::Text(text) => { /* accumulate */ }
        Event::End(TagEnd::CodeBlock) => { /* flush block */ }
        Event::Html(raw) => { /* ESCAPED â€” not rendered (XSS prevention) */ }
        _ => {}
    }
}
```
...
- Use `Result<T, String>` for error handling â€” never `panic!` on user input
