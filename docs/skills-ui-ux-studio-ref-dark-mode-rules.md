# Dark Mode Design Rules â€” Markdown Studio
...
Maximum contrast (white on pure black) is harsh. Bootstrap dark mode targets ~15:1 for body text â€” comfortable for reading but not blinding.
...
| Toolbar buttons | `btn-outline-secondary` â€” visible border, subtle hover |
