# UI/UX Studio â€” doanson44.github.io Design Intelligence
...
*Follow priority 1â†’10. Full details in `references/`.*

| Priority | Category | Impact | Key Checks |
|----------|----------|--------|------------|
| 1 | **Accessibility** | CRITICAL | Contrast â‰¥4.5:1 (both modes), Keyboard navigation, Focus visible, ARIA labels |
| 2 | **Touch & Interaction** | CRITICAL | Min 44Ã—44px touch targets, Loading states, Button spacing, Feedback on actions |
...
| 5 | **Typography** | MEDIUM | Base 16px min, Line-height â‰¥1.5, Monospace for code, Readable prose, Heading hierarchy |
...
- **What UI element?** â€” New component, restyle existing, fix UX issue
- **Where in platform?** â€” Home, Tools, Games, CV, Socket, or shared component
- **Theme constraint?** â€” Must work in BOTH `data-bs-theme="dark"` AND `data-bs-theme="light"`
- **Responsive need?** â€” Desktop vs mobile layout
...
text-body-secondary â†’ muted text (works in both modes)
