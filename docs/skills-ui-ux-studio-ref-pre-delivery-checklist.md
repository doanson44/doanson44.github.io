# Pre-Delivery Checklist â€” Markdown Studio
...
- [ ] Color contrast â‰¥4.5:1 for all text (use [WebAIM checker](https://webaim.org/resources/contrastchecker/))
...
- [ ] Split-pane layout works at â‰¥1024px (side by side)
...
- [ ] No 0ms state changes â€” transitions â‰¥150ms for visual feedback

## Typography

- [ ] Editor uses monospace font
- [ ] Preview uses readable serif or sans-serif
- [ ] Base font size â‰¥14px (never below 12px)
- [ ] Line height â‰¥1.5 for prose text
- [ ] Heading hierarchy clear in preview (h1 â†’ h2 â†’ h3)
...
- [ ] No unnecessary WASM â†” JS round-trips
